...
+ Ferreri	7/24/2020 Add Support for Laser Module
+ Ferreri	8/1/2020  Added workaround for Vectric Feedrate bug - Fixed in 10.506
+ ======== ========== ===========================

POST_NAME = "Grbl (mm) TOOLCHANGE and LASER_SUPPORT (*.nc)"
...
VAR PLUNGE_RATE = [FP|C|F|1.0|1.0]							
